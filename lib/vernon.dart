    ...
    return Scaffold(
      ...
      body: Column(
        children: const [
          ...
          Text(
              "Hansol Vernon Chwe (Korean: 최한솔; born February 18, 1998), known mononymously as Vernon (버논), is a South Korean[1] and American[2] rapper, singer and songwriter. He is a member of the South Korean boy band Seventeen under Pledis Entertainment.[3] Vernon released his first solo mixtape, Black Eye, on December 27, 2022.[4] Aside from his work with Seventeen and for himself, he has written and produced music with and for other artists such as Jamie, Bumzu, and Charli XCX.")
        ],
      ),
    );
  }
