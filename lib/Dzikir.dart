...
import 'package:latihan/zikir.dart';
import 'API.dart';
...
class _DzikirState extends State<Dzikir> {
  Future<List<dynamic>> _fetchData() async {
    var hasil = await http.get(Uri.parse(BaseUrl.zikir));
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: NetworkImage(
              'https://i.pinimg.com/474x/ed/da/ef/eddaef0e5029aa3aa6b9f3d77a5df8fe.jpg', // URL gambar latar belakang
            ),
